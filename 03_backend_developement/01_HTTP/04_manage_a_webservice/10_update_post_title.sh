...
#10_update_post_title.sh post_id new_title that updates the title of a post

# $1 post_id
# $2 new_title

curl -X PUT -H "Content-Type: application/json" -d "{\"postId\": \"${1}\", \"title\": \"${2}\"}" https://jsonplaceholder.typicode.com/posts/$1
